...
enum parameters {ABS_ZERO,EXTERNAL_TEMP_X,EXTERNAL_TEMP_Y, EXTERNAL_TEMP_Z};
...
class mesh{
    ...
    public:
        void setParameters(float zero, float f_x, float f_y, float f_z){
            parameters[ABS_ZERO]=zero;
            parameters[EXTERNAL_TEMP_X]=f_x;
            parameters[EXTERNAL_TEMP_Y]=f_y;
            parameters[EXTERNAL_TEMP_Z]=f_z;
        }
